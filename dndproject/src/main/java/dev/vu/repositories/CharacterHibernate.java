...
public class CharacterHibernate implements CharacterRepo{
    ...
    public Character getById(Integer id) {
        ...
        // Query the db
        Character a = s.get(Character.class, id);
    ...
    @Override
    public Character add(Character a) {
    ...
    @Override
    public void update(Character a) {
